...
MERGES = [
 ...
 ["Décadas de estudo e observação estão sendo organizadas e reunidas em O Código da Longevidade.","Os 5 primeiros módulos já estão disponíveis — guias, estudos e conteúdos sobre alimentação, saúde masculina,","equilíbrio físico e mental e longevidade. E quem entra agora recebe também tudo o que ainda vem."],
