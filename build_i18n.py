...
TR = [
 ...
 ("Valdoir passou décadas estudando a resposta.","Valdoir spent decades studying the answer.","Valdoir pasó décadas estudiando la respuesta."),
 ("Décadas de estudo sobre alimentação, corpo, mente e longevidade estão reunidas em","Decades of study on nutrition, body, mind and longevity are brought together in","Décadas de estudio sobre alimentación, cuerpo, mente y longevidad están reunidas en"),
 ("O Código da Longevidade","The Longevity Code","El Código de la Longevidad"),
 ("— para você viver mais e melhor, com energia e saúde em cada década que vem pela frente.","— so you can live longer and better, with energy and health in every decade ahead.","— para que vivas más y mejor, con energía y salud en cada década que viene."),
 ...
 ("+50 materiais","+50 materials","+50 materiales"),
 ...
 ("Materiais desenvolvidos","Materials developed","Materiales desarrollados"),
 ...
 ("Mais de 50 materiais desenvolvidos ao longo dos anos estão sendo reunidos em O Código da Longevidade.","More than 50 materials developed over the years are being brought together in The Longevity Code.","Más de 50 materiales desarrollados a lo largo de los años están siendo reunidos en El Código de la Longevidad."),
 ("Os 5 primeiros módulos já estão disponíveis — guias, estudos e conteúdos sobre alimentação, saúde masculina,","The first 5 modules are already available — guides, studies and content on nutrition, male health,","Los primeros 5 módulos ya están disponibles — guías, estudios y contenidos sobre alimentación, salud masculina,"),
 ...
 ("Organização do acervo: 35% concluído","Collection progress: 35% complete","Organización del acervo: 35% completado"),
 ...
 ("(hoje em 35%)","(today at 35%)","(hoy en 35%)"),
...
MERGES = [
 ...
 ["Mais de 50 materiais desenvolvidos ao longo dos anos estão sendo reunidos em O Código da Longevidade.","Os 5 primeiros módulos já estão disponíveis — guias, estudos e conteúdos sobre alimentação, saúde masculina,","equilíbrio físico e mental e longevidade. E quem entra agora recebe também tudo o que ainda vem."],
